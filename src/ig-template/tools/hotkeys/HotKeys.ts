...
export class HotKeys {
     ...
     */
    protected static _keyBinds: KeyBind[] = [];

    /**
     * Register a keybind with mousetrap, but add the requirement in the callback.
     */
    public static addKeyBind(keyBind: KeyBind): void {
     ...
     */
    public static removeKeyBind(keys: string | string[], action = KeyEventType.KeyDown): void {
     ...
     */
    public static trigger(keys: string, action = KeyEventType.KeyDown): void {
