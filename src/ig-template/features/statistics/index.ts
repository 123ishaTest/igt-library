export { AbstractStatistic } from '@/ig-template/features/statistics/AbstractStatistic';
export { ArrayStatistic } from '@/ig-template/features/statistics/ArrayStatistic';
export { IgtStatistics } from '@/ig-template/features/statistics/IgtStatistics';
