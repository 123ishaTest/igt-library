export { AbstractConsumable } from '@/ig-template/features/items/AbstractConsumable';
export { AbstractDataItem } from '@/ig-template/features/items/AbstractDataItem';
export { AbstractItem } from '@/ig-template/features/items/AbstractItem';
