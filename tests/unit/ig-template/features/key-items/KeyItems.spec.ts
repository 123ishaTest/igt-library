...
describe('Key Items', () => {
  ...
  test('normal usage', () => {
    ...
    keyItems.registerKeyItem(new KeyItem(id, 'title', ''));
  ...
  test('dont unlock impossible', () => {
    ...
    const keyItem = keyItems.registerKeyItem(
      new KeyItem(id, 'title', '', 'hint', 'image', new ImpossibleRequirement()),
    );
  ...
  test('load', () => {
    const keyItems = new IgtKeyItems();
    const keyItem = keyItems.registerKeyItem(new KeyItem(id, 'title', ''));
