...
describe('Achievements', () => {
  ...
  test('array stat achievement', () => {
    ...
    const achievement = achievements.registerAchievement(
      new Achievement(id, 'title', '', new ArrayStatisticRequirement(array, 1, 3)),
    );
  ...
  test('test unlock', () => {
    ...
    const achievements = new IgtAchievements();
    const achievement = achievements.registerAchievement(new Achievement(id, 'title', '', new NoRequirement()));
  ...
  test('custom achievements', () => {
    const achievements = new IgtAchievements();
    const achievement = achievements.registerAchievement(new CustomAchievement(id, 'title', ''));
  ...
  test('get progress', () => {
    const achievements = new IgtAchievements();
    const achievement = achievements.registerAchievement(new Achievement(id, 'title', '', new ImpossibleRequirement()));
  ...
  test('save and load', () => {
    // Arrange
    const achievements = new IgtAchievements();
    const achievement = achievements.registerAchievement(new Achievement(id, '', '', new NoRequirement()));
