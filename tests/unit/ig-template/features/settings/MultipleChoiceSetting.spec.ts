...
describe('Multiple Choice Setting', () => {
  ...
  test('valid default setting', () => {
    // Arrange
    const setting = new MultipleChoiceSetting(id, 'Example setting', [new SettingOption('Option 1', 2)], 2);
  ...
  test('invalid default setting', () => {
    expect(() => {
      new MultipleChoiceSetting(id, 'Example setting', [new SettingOption('Option 1', 2)], 2123123);
    }).toThrow();
  });

  test('set setting', () => {
    // Arrange
    const setting = new MultipleChoiceSetting(
      id,
      'Example setting',
      [new SettingOption('Option 1', 1), new SettingOption('Option 2', 2)],
      1,
    );
